...
public class Spark4UServiceImpl implements SparkService {
    ...
    public void init() {
        executor = new ThreadPoolExecutor(
                ...
                new DubboServiceThreadFactory("Spark4UServiceImpl"),
    ...
    @Override
    public CompletableFuture<CodeOptimizeResp> codeOptimize(CodeOptimizeReq req) {
        Supplier<CodeOptimizeResp> runner = () -> {
        ...
        return CompletableFuture.supplyAsync(runner, executor);
    }
}
